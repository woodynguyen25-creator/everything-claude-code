...
**That's it!** You now have access to 47 agents, 212 skills, and 81 legacy command shims.
...
| Commands | PASS: 81 commands | PASS: 31 commands | **Claude Code leads** |
| Skills | PASS: 212 skills | PASS: 37 skills | **Claude Code leads** |
...
| **Commands** | 81 | Shared | Instruction-based | 31 |
| **Skills** | 212 | Shared | 10 (native format) | 37 |
